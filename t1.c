...
if(light==0 && (i>=330 && i<=750)) //value of i when first vehicle is near the traffic-signal//650
 {
...
if(light==0 && (i>=830 && i<=1100)) //value of i when second vehicle is near the traffic-signal//900
 {
...
if(light==0 && (i>=1200 && i<=1620))// value of i when third vehicle is near the traffic signal//1400
 {
